...
def test_and_get_scores(
    ...
    INTERPOLATE_BEFORE_PREDICTION = True
    ...
    with torch.no_grad():
        for batch in loop:
            ...
            # Only linear interpoaltion - no model prediction
            pred_rot, pred_pos = src_rot, src_pos
...
if __name__ == "__main__":
    ...
    print(f"Test Results for linear interpolation (window step: {window_step}):")
